...
texture = Path("Data/Husky/models/baked_mesh_tex0.png") # load texture for husky

bproc.init()

# load bop objects into the scene
target_bop_objs = bproc.loader.load_bop_objs(bop_dataset_path = os.path.join(bop_parent_path, 'Husky'), mm2m = True)
...
bproc.loader.load_bop_intrinsics(bop_dataset_path = os.path.join(bop_parent_path, 'Husky'))
...
for obj in (sampled_target_bop_objs):
    ...
    if obj.get_cp("bop_dataset_name") in ["Husky"]:
